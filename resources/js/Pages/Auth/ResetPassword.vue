<template>
    <form @submit.prevent="resetPassword" class="flex justify-center items-center min-h-screen bg-gray-100">
        <div class="w-full max-w-lg p-8 space-y-6 bg-white shadow-lg rounded-xl">
            <h2 class="text-center text-2xl font-bold text-gray-700">Reset Password</h2>
            <div class="space-y-4">
                <div>
            ...
            <div class="mt-2 text-center">
                <Link :href="route('homepage')" class="text-sm text-indigo-600 hover:text-indigo-800">Go back home.
                </Link>
            </div>
        </div>
    </form>
