<template>
    <div class="max-w-2xl mx-auto py-8 px-4 bg-white shadow-lg rounded-lg">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">Answer Details:</h3>
        <ul>
        ...
        <h3 class="text-xl font-semibold text-gray-700 mt-6 mb-2">Summary:</h3>
        <p class="text-lg text-gray-600">Total Correct Answers: {{ count_correct }}</p>
        <p class="text-lg text-gray-600">Total Incorrect Answers: {{ count_incorrect }}</p>
    </div>
</template>
